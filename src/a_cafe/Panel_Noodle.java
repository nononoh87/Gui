...
public class Panel_Noodle extends JPanel {
	...
	public Panel_Noodle(MainTest mainTest) {
		...
		ta = new JTextArea();
		//메뉴 관련버튼 (이미지 경로)
		bnd1 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\1.PNG"));
		bnd2 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\2.PNG"));
		bnd3 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\3.PNG"));
		bnd4 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\4.PNG"));
		bnd5 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\5.PNG"));
		bnd6 = new JButton(new ImageIcon("src\\a_cafe\\imgs\\6.PNG"));
		//주문 관련 버튼
